...
try {
    $stmt = $pdo->query("SELECT * FROM books WHERE genre = 'Sách Việt Nam'");
...
<body>
    <div id="main">
        ...
        <div id="content">
                    ...
                    <ul>
                        ...
                        <i class="fa-solid fa-caret-down"></i>
                            <ul id="sub-menu">
                                ...
                                <li>
                                    <a href="#">Sách Việt Nam</a>
                                    <i class="sub-menu-angle-right ti-angle-right"></i>
                                </li>
                                <li>
                                    <a href="menusachnn.php">Sách Nước ngoài</a>
                                    <i class="sub-menu-angle-right ti-angle-right"></i>
                                </li>
                            </ul>
                        </li>
            ...
            <!-- Breadcrumb -->
            <div class="book-type">
                <a href="../index.php">Trang chủ</a> / <a href="">Sách Việt Nam</a>
            </div>
            ...
            <div id="comic-list">
                <?php foreach ($comics as $comic): ?>
                    <div class="comic-name">
                        <a href="/Bansach/thanhtoan/thanhtoansachvn.php?id=<?= $comic['id']; ?>">
